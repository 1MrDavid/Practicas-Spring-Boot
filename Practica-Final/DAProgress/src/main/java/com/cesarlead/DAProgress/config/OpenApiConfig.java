...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenApiConfig() {
        return new OpenAPI()
                .info(new Info()
                        .title("API de Gestión del progreso de los Cursos")
                        .version("1.0.0")
                        .description("Microservicio para gestionar la información base (CRUD) del progreso de los cursos de la Academia Digital.")
                        .contact(new Contact()
