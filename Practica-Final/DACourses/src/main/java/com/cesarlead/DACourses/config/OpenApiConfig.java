...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenApiConfig() {
        return new OpenAPI()
                .info(new Info()
                        .title("API de Gestión de Cursos e Inscripciones")
                        .version("1.0.0")
                        .description("Microservicio para gestionar la información base (CRUD) de los cursos y las inscripciones a estos de la Academia Digital.")
                        .contact(new Contact()
